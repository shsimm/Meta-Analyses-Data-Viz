...
library('metafor')
library('plyr') # DO NOT USE THIS IN CONJUCTION WITH DPLYR
library('biomaRt')
library('ggrepel')
library('ggbeeswarm')
library('patchwork')
...
```{r Create Plot themes}

My_Inter_Theme = theme(
...
# write.csv(DE_mega_interaction, "~/Desktop/School/UofT MSc Medical Science/Research/Thesis Research/Data Frames/DEG/Interaction\\DE_mega_interaction.csv",row.names = FALSE)
